function flag = analyze_perf_hog3d(model, methods, param_names, param_names_plot)
%%
...
est_full_amh_cput = avg_fsp_time*nchain;
...
dahyb_cput_saving_percent = 100*(est_full_amh_cput - max(dahyb_perf.phase1.cput) - max(dahyb_perf.phase2.cput))/est_full_amh_cput;
write_file([model '_dahyb_cput_saving_percent.tex'], '%.2f', dahyb_cput_saving_percent);

damh_cput_saving_percent = 100*(est_full_amh_cput - max(damh_perf.cput))/est_full_amh_cput;
